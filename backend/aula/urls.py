...
urlpatterns = [
    ...
    path("<int:aula_do_aluno_id>/presenca", views_aula_do_aluno.AulaDoAlunoView.registrar_presenca, name='registrar_presenca'),
    path("detail/<int:aula_id>/aluno", views_aula_do_aluno.AulaDoAlunoView.adicionar_aluno_em_aula, name='adicionar_aluno_em_aula'),
    path("detail/<int:aula_id>/aluno/delete/<int:aluno_id>", views_aula_do_aluno.AulaDoAlunoView.deletar_aluno_de_aula_template, name='deletar_aluno_de_aula_template'),
    path("detail/<int:aula_id>/aluno/delete/<int:aluno_id>/confirm", views_aula_do_aluno.AulaDoAlunoView.deletar_aluno_de_aula, name='deletar_aluno_de_aula'),
]
